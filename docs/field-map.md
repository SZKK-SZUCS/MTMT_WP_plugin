...
**Fontos architektúra-elv (nem csak ennél a telepítésnél):** SEM a `257`, SEM a `19662` nem kerül semmilyen PHP-kódba hardcode-olva. Az intézmény-mtid (vagy szerző-mtid-lista) kizárólag a `wp_mtmt_query_profiles.cond_json`-ban él, telepítésenként/site-onként beállítva — lásd „Query profil = dobozos scope-konfiguráció" lentebb.
